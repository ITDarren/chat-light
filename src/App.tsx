...
export default function App() {
  ...
  const handleSendMessage = async (textToSend?: string) => {
    ...
    try {
      ...
      console.error(error);
      setErrorMsg(error?.message || "連線異常，請稍後重試。");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <AnimatePresence mode="wait">
          {!started ? (
            ...
            <motion.div
              ...
              className="flex-1 flex flex-col justify-between p-6 bg-gradient-to-b from-indigo-50/50 via-white to-white overflow-y-auto"
            >
              {/* Header Visual */}
            ...
            >
              {/* Header bar */}
              <div className="bg-white border-b border-slate-100 p-4 flex items-center justify-between shadow-xs shrink-0 relative">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start justify-between gap-2 p-1.5 rounded-lg hover:bg-slate-50 transition-colors">
                            <div className="flex items-start gap-2">
                              <span className={`w-4 h-4 rounded-full flex items-center justify-center border text-[9px] font-bold mt-0.5 shrink-0 ${
                                session.phase !== 'discovery' || session.misunderstoodWord 
                      ...
                      <React.Fragment key={step.phase}>
                        ...
                        <div className="flex items-center gap-1.5 relative shrink-0">
                          ...
                          <motion.span
                            ...
                            className={`w-6 h-6 rounded-lg flex items-center justify-center text-[11px] font-sans z-10 transition-all duration-300 relative ${
                              isActive
                ...
                {messages.map((m) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col max-w-[80%]">
                      <div 
                        className={`p-3 px-4 rounded-2xl text-[13px] leading-relaxed relative ${
                          m.role === "assistant" 
                      ...
                      >
                        ...
                        {m.role === "assistant" && (
                          <button
                            ...
                            className={`absolute -bottom-2.5 -right-2 w-6 h-6 rounded-full shadow-sm flex items-center justify-center transition border ${
              ...
              <div className="p-3 px-4 bg-white border-t border-slate-100 flex items-center min-h-[64px] shrink-0 relative overflow-hidden">
                <AnimatePresence mode="wait">
                  {isRecording ? (
                    ...
                    >
                      ...
                      <div className="flex-1 relative flex items-center min-w-0">
                        <input
                          ...
                          className={`w-full border text-slate-800 text-xs rounded-xl p-3 focus:outline-none bg-slate-50 font-sans disabled:opacity-50 transition-all ${
                            isReframingActive
                        ...
                        <AnimatePresence>
                          {inputValue.trim().length > 0 && (
                            <motion.button
                              ...
                              className={`absolute right-1.5 w-8 h-8 rounded-lg flex items-center justify-center transition-all shadow-sm shrink-0 cursor-pointer ${
                                isReframingActive
                        ...
                        {inputValue.trim().length === 0 && (
                          ...
                          >
                            ...
                            <motion.button
                              ...
                              onClick={toggleRecording}
                              disabled={isLoading || isReframingActive}
                              className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all shadow-xs shrink-0 cursor-pointer ${
                                isReframingActive
              ...
              <div className="flex-1 flex flex-col items-center justify-center my-6 max-w-md w-full space-y-12">
                ...
                <div className="relative w-72 h-72 flex items-center justify-center">
                  ...
                  <AnimatePresence>
                    {breathingPhase !== "ready" && (
                      <motion.div
                        ...
                        className={`absolute inset-0 rounded-full blur-2xl filter opacity-20 ${
                          breathingPhase === "inhale" ? "bg-teal-500" :
                  ...
                  <motion.div
                    ...
                    className={`w-40 h-40 rounded-full flex flex-col items-center justify-center shadow-2xl relative transition-colors duration-1000 border border-white/10 ${
                      breathingPhase === "ready" ? "bg-gradient-to-br from-slate-800 to-slate-900 text-slate-350" :
                        ...
                        {[1, 2, 3, 4].map((c) => (
                          <div
                            ...
                            className={`h-2 rounded-full transition-all duration-500 ${
                              c < breathingCycle ? "w-6 bg-teal-500" :
